export default function MessageBubble({ message, currentUserId, senderName }) {
  ...
  if (message.message_type === 'text') {
    ...
    content = (
      <div
        className="border rounded-lg p-3 bg-white cursor-pointer hover:bg-gray-50 transition flex gap-3"
        onClick={() => {
      ...
      >
        <img
          src={message.product_image || '/assets/images/default-product.png'}
